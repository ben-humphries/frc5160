...
public class TwoGearAuto extends CommandGroup {
	public TwoGearAuto(){
		addSequential(new CMDAutoTankDrive(64*80,0,0.3),1.45);
		addSequential(new CMDAutoTankDrive(-64*80,0,0.3),1.3);
		addSequential(new CMDAutoRotate(90, 0.5),1);
		addSequential(new CMDTrackGearGround(),1.5);
		addSequential(new CMDAutoTankDrive(64*80,0,0.5),0.3);
		addSequential(new CMDAutoTankDrive(-64*80,0,0.5),0.2);
		addSequential(new CMDAutoRotate(-90, 0.5),1);
