...
public class EncoderTalon extends CANTalon {
	...
	public void setPID(PID pid) {
		if (this.pid != null) { this.pid.removeDependency(this); System.out.println("WARNING: Talon registered for multiple PID profiles!");}
		this.pid = pid;
		pid.addDependency(this);
		submitPIDValues(pid);
	}
	
	public void submitPIDValues(PID pid) {
		setPID(pid.getP(), pid.getI() / 10000.0, pid.getD());
	}
